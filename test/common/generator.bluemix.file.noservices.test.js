...
const fs = require('fs');
const bluemixOptions = fs.readFileSync(path.join(__dirname, '../../test/resources/bluemix-template.json'), 'utf8');
...
describe('Generates a no framework web app project using cmd line options with --bluemix', function () {
